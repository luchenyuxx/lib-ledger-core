...
NAN_METHOD(NJSEthereumLikeTransactionBuilder::sendToAddress) {
    ...
    NJSEthereumLikeTransactionBuilder* obj = Nan::ObjectWrap::Unwrap<NJSEthereumLikeTransactionBuilder>(info.This());
    ...
    auto arg_2_wrap = NJSEthereumLikeTransactionBuilder::wrap(result);
    auto arg_2 = Nan::ObjectWrap::Unwrap<NJSEthereumLikeTransactionBuilder>(arg_2_wrap)->handle();
...
NAN_METHOD(NJSEthereumLikeTransactionBuilder::wipeToAddress) {
    ...
    //Wrap result in node object
    auto arg_1_wrap = NJSEthereumLikeTransactionBuilder::wrap(result);
    auto arg_1 = Nan::ObjectWrap::Unwrap<NJSEthereumLikeTransactionBuilder>(arg_1_wrap)->handle();
...
NAN_METHOD(NJSEthereumLikeTransactionBuilder::parseRawUnsignedTransaction) {
    ...
    //Wrap result in node object
    auto arg_2_wrap = NJSEthereumLikeTransaction::wrap(result);
    auto arg_2 = Nan::ObjectWrap::Unwrap<NJSEthereumLikeTransaction>(arg_2_wrap)->handle();
...
NAN_METHOD(NJSEthereumLikeTransactionBuilder::New) {
    ...
    NJSEthereumLikeTransactionBuilder *node_instance = new NJSEthereumLikeTransactionBuilder(nullptr);
...
Handle<Object> NJSEthereumLikeTransactionBuilder::wrap(const std::shared_ptr<ledger::core::api::EthereumLikeTransactionBuilder> &object) {
    ...
    if(!local_prototype.IsEmpty())
    {
        ...
        NJSEthereumLikeTransactionBuilder *new_obj = new NJSEthereumLikeTransactionBuilder(object);
        if(new_obj)
        {
            new_obj->Wrap(obj);
            new_obj->Ref();
