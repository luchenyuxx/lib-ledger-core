    ...
    if(result)
    {
        ...
        for(size_t arg_0_tmp_id = 0; arg_0_tmp_id < arg_0_optional.size(); arg_0_tmp_id++)
        {
            ...
            if(arg_0_optional[arg_0_tmp_id].ethereumLikeNetworkParameters)
            {
                ...
                for(size_t arg_0_tmp_elem_7_tmp_3_id = 0; arg_0_tmp_elem_7_tmp_3_id < arg_0_tmp_elem_7_optional.ChainID.size(); arg_0_tmp_elem_7_tmp_3_id++)
                {
                    auto arg_0_tmp_elem_7_tmp_3_elem = Nan::New<Uint32>(arg_0_tmp_elem_7_optional.ChainID[arg_0_tmp_elem_7_tmp_3_id]);
