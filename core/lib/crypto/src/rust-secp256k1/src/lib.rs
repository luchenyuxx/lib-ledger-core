...
/*******************************************/
#[no_mangle]
pub extern fn secp256k1_context_create_rust(flags: c_uint) -> *mut ffi::Context{
    unsafe {
        ffi::secp256k1_context_create(flags)
    }
}

#[no_mangle]
pub extern fn secp256k1_ecdsa_signature_serialize_der_rust(cx: *const ffi::Context,
                                                     output: *mut c_uchar,
                                                     out_len: *mut size_t,
                                                     sig: *const ffi::Signature) -> c_int {
    unsafe {
        ffi::secp256k1_ecdsa_signature_serialize_der(cx, output, out_len, sig)
    }
}

#[no_mangle]
pub extern fn secp256k1_ec_pubkey_parse_rust(cx: *const ffi::Context,
                                             pk: *mut ffi::PublicKey,
                                             input: *const c_uchar,
                                             in_len: size_t) -> c_int {
    unsafe {
        ffi::secp256k1_ec_pubkey_parse(cx, pk, input, in_len)
    }
}

#[no_mangle]
pub extern fn secp256k1_ecdsa_signature_parse_der_rust(cx: *const ffi::Context,
                                                       sig: *mut ffi::Signature,
                                                       input: *const c_uchar,
                                                       in_len: size_t) -> c_int {
    unsafe {
        ffi::secp256k1_ecdsa_signature_parse_der(cx, sig, input, in_len)
    }
}

#[no_mangle]
pub extern fn secp256k1_ecdsa_verify_rust(cx: *const ffi::Context,
                                          sig: *const ffi::Signature,
                                          msg32: *const c_uchar,
                                          pk: *const ffi::PublicKey) -> c_int {
    unsafe {
        ffi::secp256k1_ecdsa_verify(cx, sig, msg32, pk)
    }
}

#[no_mangle]
pub extern fn secp256k1_ec_pubkey_serialize_rust(cx: *const ffi::Context, output: *mut c_uchar,
                                                 out_len: *mut size_t, pk: *const ffi::PublicKey,
                                                 compressed: c_uint) -> c_int {
    unsafe {
        ffi::secp256k1_ec_pubkey_serialize(cx, output, out_len, pk, compressed)
    }
}

#[no_mangle]
pub extern fn secp256k1_context_destroy_rust(cx: *mut ffi::Context) {
    unsafe {
        ffi::secp256k1_context_destroy(cx)
    }
}

#[no_mangle]
pub extern fn secp256k1_ec_pubkey_tweak_add_rust(cx: *const ffi::Context,
                                          pk: *mut ffi::PublicKey,
                                          tweak: *const c_uchar) -> c_int {
    unsafe {
        ffi::secp256k1_ec_pubkey_tweak_add(cx, pk, tweak)
    }
}
